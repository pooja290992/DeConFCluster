...
def model_configs():
    ...
    n_epochs = [25]
    n_batch = [203]#[1600]
    lam_mu_km_list = [(0.01,0.0001,0.8)]#[(0.01,0.0001,0.5)]#[(0.01,0.0001,1)]#[(0.01,0.0001,0.3)]#[(0.01,0.0001,0.1)]
...
res_base_path = base_path + 'Results/ablation/regularizers/km_reg/'  + source + '/' + source + '_'
