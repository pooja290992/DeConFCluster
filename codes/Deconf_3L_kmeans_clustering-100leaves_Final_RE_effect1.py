...
def model_configs():
    ...
    n_epochs = [25]
    n_batch = [1600]
    lam_mu_km_list = [(0.01,0.0001,0.8)]#[(0.01,0.0001,1)]#[(0.01,0.0001,0.1)]#[(0.01,0.0001,0.3)]#[(0.01,0.0001,0.5)]#
...
def createParamPath(epochs, batch_size, lamda, mean, km_reg, lr, gamma, ks_f, wd, mpl_ks, maxpools, amsFlg, activFunc, 
    ...
    if custom_batch_size_flag == True:
        param_path = 'ep_' + str(epochs) + '_bs' + str(batch_size) + '_lam' + str(lamda) + '_mu' + str(mean) + '_kmreg' + str(km_reg) +                '_lr' + str(lr) + '_gm' + str(gamma) + '_wd' + str(wd) +  '_ks1_' + str(ks1) + '_ks2' + str(ks2) + '_ks3' + str(ks3) +'_opl1' +                 str(out_pl1) + '_opl2' + str(out_pl2) + '_opl3' + str(out_pl3) +'_mpl1' + str(maxpl1)[0] + '_mpl2' + str(maxpl2)[0] + '_mpl3' + str(maxpl3)[0] +             '_ams' + str(amsFlg) + '_atmrat' + str(atom_ratio) + '_af' + activFunc + '_loss' + loss_func + '_x' + str(xstep_flg)[0] + '_z' + str(zstep_flg)[0] 
    else:
        param_path = 'ep_' + str(epochs) + '_lam' + str(lamda) + '_mu' + str(mean) + '_kmreg' + str(km_reg) +                '_lr' + str(lr) + '_gm' + str(gamma) + '_wd' + str(wd) +  '_ks1_' + str(ks1) + '_ks2' + str(ks2) + '_ks3' + str(ks3) +'_opl1' +                 str(out_pl1) + '_opl2' + str(out_pl2) + '_opl3' + str(out_pl3) +'_mpl1' + str(maxpl1)[0] + '_mpl2' + str(maxpl2)[0] + '_mpl3' + str(maxpl3)[0] +             '_ams' + str(amsFlg) + '_atmrat' + str(atom_ratio) + '_af' + activFunc + '_loss' + loss_func + '_x' + str(xstep_flg)[0] + '_z' + str(zstep_flg)[0] 
    return param_path
...
res_base_path = base_path + 'Results/ablation/regularizers/km_reg/' + source + '_'
...
#     print(scores_df.head())
    ...
    results_file_name2 = res_base_path + 'res_dcfl3_' + loss_func + '_kmreg.csv'
...
# configs_list[4], configs_list[13]
