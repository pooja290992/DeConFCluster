...
def model_configs():
    ...
    n_epochs = [25]
    n_batch = [203]
    lam_mu_km_list = [(0.01,0.0001,0.8)]#[(0.01,0.001,0.8)]#[(0.001,0.0001,0.8)]#[(0.001,0.00001,0.8)]#[(0.0001,0.00001,0.8)]#
...
res_base_path = base_path + 'Results/ablation/regularizers/lammu_reg/'  + source + '/' + source + '_'
